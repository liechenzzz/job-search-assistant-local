...
const REQUIRED_KEYWORD_RULES: KeywordRule[] = [
  ...
  { label: "Python", pattern: /\bpython\b/i, focus: "Python analysis" },
  {
    label: "Excel",
    pattern: /\bexcel\b/i,
    focus: "Excel analysis and reporting",
  },
  ...
  {
    label: "reporting",
    pattern: /\breporting|reports?\b/i,
    focus: "reporting",
  },
  {
    label: "data quality",
    pattern: /\bdata quality|quality assurance|qa\b/i,
    focus: "QA and validation",
  },
  { label: "KPI", pattern: /\bkpis?\b/i, focus: "KPI reporting" },
  {
    label: "stakeholder",
    pattern: /\bstakeholders?\b/i,
    focus: "stakeholder synthesis",
  },
  {
    label: "research",
    pattern: /\bresearch|analysis|analytical\b/i,
    focus: "analysis and research",
  },
  {
    label: "policy analysis",
    pattern: /\bpolicy analysis|policy research\b/i,
    focus: "policy analysis",
  },
  {
    label: "program evaluation",
    pattern: /\bprogram evaluation|evaluation framework\b/i,
    focus: "program evaluation",
  },
  {
    label: "market research",
    pattern: /\bmarket research|consumer insights|survey\b/i,
    focus: "research insights",
  },
  {
    label: "strategy",
    pattern: /\bstrategy|strategic\b/i,
    focus: "strategy work",
  },
  {
    label: "project management",
    pattern: /\bproject management|implementation|delivery\b/i,
...
const DOMAIN_KEYWORD_RULES: KeywordRule[] = [
  {
    label: "NOC",
    pattern: /\bnoc\b|\bnational occupational classification\b/i,
  },
  {
    label: "NAICS",
    pattern: /\bnaics\b|\bnorth american industry classification\b/i,
  },
  ...
  { label: "municipal", pattern: /\bmunicipal|city of|regional government\b/i },
  {
    label: "public sector",
    pattern:
      /\bpublic sector|government|province of|ontario public service|\bops\b/i,
  },
  { label: "economic development", pattern: /\beconomic development\b/i },
  { label: "labour market", pattern: /\blabou?r market|workforce\b/i },
  {
    label: "jurisdictional scan",
    pattern: /\bjurisdictional scan|jurisdictional review\b/i,
  },
];
