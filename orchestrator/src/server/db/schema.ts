...
export const jobs = sqliteTable(
  "jobs",
  {
    ...
    jdKeywordProfile: text("jd_keyword_profile"),
    jdQualificationProfile: text("jd_qualification_profile"),
    jdServiceValueBrief: text("jd_service_value_brief"),
    resumeAlignmentReport: text("resume_alignment_report"),
    resumeServiceFitReport: text("resume_service_fit_report"),
    resumePositioningPlan: text("resume_positioning_plan"),
    resumeTargetPagesOverride: integer("resume_target_pages_override"),
