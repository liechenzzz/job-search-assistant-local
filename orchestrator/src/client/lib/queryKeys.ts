...
export const queryKeys = {
  designResume: {
    ...
    current: (variant: DesignResumeVariant = "two_page") =>
      [...queryKeys.designResume.all, "current", variant] as const,
    status: (variant: DesignResumeVariant = "two_page") =>
      [...queryKeys.designResume.all, "status", variant] as const,
  },
  settings: {
    all: ["settings"] as const,
    current: () => [...queryKeys.settings.all, "current"] as const,
    resumeReferences: () =>
      [...queryKeys.settings.all, "resume-references"] as const,
  },
  profile: {
