...
const makeJob = (overrides: Partial<JobListItem>): JobListItem => ({
  ...
  ...overrides,
  relevanceStatus: overrides.relevanceStatus ?? null,
  relevanceReason: overrides.relevanceReason ?? null,
  availabilityStatus: overrides.availabilityStatus ?? null,
  availabilityReason: overrides.availabilityReason ?? null,
  availabilityCheckedAt: overrides.availabilityCheckedAt ?? null,
});
