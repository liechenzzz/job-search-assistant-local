...
export type ChatValues = {
  ...
  humanizerEnabled: EffectiveDefault<boolean>;
  impactFramingEnabled: EffectiveDefault<boolean>;
  roleFramingMode: EffectiveDefault<RoleFramingMode>;
  manualRoleFamily: EffectiveDefault<ApplicationRoleFamily>;
  customRoleFramingInstructions: EffectiveDefault<string>;
};
