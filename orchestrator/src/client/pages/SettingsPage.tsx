...
const SETTINGS_NAV_GROUPS: SettingsNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Writing Style",
        description:
          "Tone, language, humanizer, impact framing, role strategy, and writing constraints.",
        searchTerms: [
          "ghostwriter",
          "language",
          "tone",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Local resume and cover letter examples for tailoring QA.",
        searchTerms: [
          "resume",
          "cover letter",
          "references",
...
const NULL_SETTINGS_PAYLOAD: UpdateSettingsInput = {
  ...
  ontarioPublicSectorMaxJobs: null,
  webhookSecret: null,
...
const mapSettingsToForm = (data: AppSettings): UpdateSettingsInput => ({
  ...
  humanizerEnabled: data.humanizerEnabled.override,
  impactFramingEnabled: data.impactFramingEnabled.override,
  roleFramingMode: data.roleFramingMode.override ?? null,
  manualRoleFamily: data.manualRoleFamily.override ?? null,
  customRoleFramingInstructions:
    data.customRoleFramingInstructions.override ?? "",
...
const getDerivedSettings = (settings: AppSettings | null) => {
  ...
  return {
    ...
    chat: {
      ...
      humanizerEnabled: {
        effective: settings?.humanizerEnabled?.value ?? true,
        default: settings?.humanizerEnabled?.default ?? true,
      },
      impactFramingEnabled: {
        effective: settings?.impactFramingEnabled?.value ?? true,
        default: settings?.impactFramingEnabled?.default ?? true,
      },
      roleFramingMode: {
        effective: settings?.roleFramingMode?.value ?? "auto",
        default: settings?.roleFramingMode?.default ?? "auto",
      },
      manualRoleFamily: {
        effective:
        ...
        default:
          settings?.manualRoleFamily?.default ??
          "public_sector_policy_economic_development",
      },
      customRoleFramingInstructions: {
        effective: settings?.customRoleFramingInstructions?.value ?? "",
        default: settings?.customRoleFramingInstructions?.default ?? "",
      },
    },
    envSettings: {
      readable: {
  ...
  const onSave = async (data: UpdateSettingsInput) => {
    ...
    try {
      ...
      const payload: Partial<UpdateSettingsInput> = {
        ...
        humanizerEnabled: nullIfSame(
          data.humanizerEnabled,
          chat.humanizerEnabled.default,
        ),
        impactFramingEnabled: nullIfSame(
          data.impactFramingEnabled,
          chat.impactFramingEnabled.default,
        ),
        roleFramingMode: nullIfSame(
          data.roleFramingMode,
          chat.roleFramingMode.default,
        ),
        manualRoleFamily: nullIfSame(
          data.manualRoleFamily,
          chat.manualRoleFamily.default,
        ),
        customRoleFramingInstructions: nullIfSame(
          normalizeString(data.customRoleFramingInstructions),
          chat.customRoleFramingInstructions.default,
        ),
