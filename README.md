...
> Privacy-clean self-hosted fork published as `job-search-assistant-local`.
> Local profiles, resumes, application records, generated documents, databases,
> logs, credentials, and session data are intentionally excluded. Original
> project and attribution: [DaKheera47/job-ops](https://github.com/DaKheera47/job-ops).
...
```bash
git clone https://github.com/liechenzzz/job-search-assistant-local.git
cd job-search-assistant-local
docker compose up -d
```
